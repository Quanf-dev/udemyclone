...
const AddCourse = () => {
  ...
  const handleOpen = (course) => {
    ...
    setNewCourse({
      ...course,
      skills: course.skills.join(", "), // Convert skills array to comma-separated string for easier editing
    });
    setOpen(true);
  };
  ...
  const handleInputChange = (e) => {
    ...
    if (name === "skills") {
      // Handle skills as a comma-separated string and convert it back to an array
      setNewCourse((prev) => ({
        ...prev,
        [name]: value.split(",").map((skill) => skill.trim()), // Convert back to array of trimmed strings
      }));
    } else {
      ...
      <Modal open={open} onClose={handleClose}>
        ...
        >
          ...
          <TextField
            ...
            fullWidth
            margin="normal"
            value={newCourse.skills.join(", ")} // Join array to display in input
            onChange={handleInputChange}
          />
          <Button
            variant="contained"
