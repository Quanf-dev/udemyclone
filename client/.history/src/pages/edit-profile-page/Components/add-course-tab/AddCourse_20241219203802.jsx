...
import CourseCard from "../course-card/CourseCard"; // Make sure this import is correct
      ...
      <Grid container spacing={2}>
        {courses.map((course, index) => (
          <Grid item xs={12} sm={6} md={4} key={index}>
            {/* Pass handleEditOpen as prop to CourseCard */}
            <CourseCard
              course={course}
              onEdit={() => handleEditOpen(course)} // Pass the editing handler
            />
          </Grid>
        ))}
      </Grid>
