              ...
              <div className={styles.hide}>
                <section className={styles.priceAndOffer}>
                  <p className={styles.headerPrice}>
                    <span className={styles.bigPrice}>E£199.99</span>
                    <span className={styles.smallPrice}>E£679.99</span>
                    <span className={styles.offerSize}>71% off</span>
                  </p>
                  <p className={styles.timeRemaining}>
                    <i className="fa-regular fa-clock"></i>
                    <span className={styles.offerText}>
                      <span className={styles.bold}>5 hours</span> left at this
                      price!
                    </span>
                  </p>
                </section>
