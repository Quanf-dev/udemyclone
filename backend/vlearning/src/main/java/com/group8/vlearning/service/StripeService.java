...
public class StripeService {
    ...
    public StripeResponse checkoutProducts(StripeRequest productRequest) {
        ...
        SessionCreateParams.LineItem.PriceData priceData = SessionCreateParams.LineItem.PriceData.builder()
                .setCurrency(productRequest.getCurrency() != null ? productRequest.getCurrency() : "VND")
        ...
        SessionCreateParams params = SessionCreateParams.builder()
                ...
                .setSuccessUrl(domainName + "/v1/success")
                .setCancelUrl(domainName + "/v1/cancel")
                .addLineItem(lineItem)
                .putMetadata("productId", productRequest.getProductId() + "") // Thêm ID sản phẩm vào metadata
